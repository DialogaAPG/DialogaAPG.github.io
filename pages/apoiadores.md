...
### Page/Post
The [page/post format]({{ site.url }}/propostas/regularizacao/) has no sidebar by default, its content is centered and beneath the content the visitor gets some metadata like categories, tags, date and author if provided via data in front matter of the post.
...
### Page Full Width
If you want full control of styling a page, then use the [page fullwidth template]({{ site.url }}/propostas/transparencia/). To set up a grid, just use the [foundation grid system](http://foundation.zurb.com/docs/components/grid.html).
...
### Video
If you're a video producer or cineast, you'll like the [video template]({{ site.url }}/propostas/video/). It darkens the layout to black and lets the video stand out full-width.
