...
:   Now with audio- and video-player [mediaelement.js]({{ site.url }}/propostas/mediaelement_js/). Added new gallery include. Changed names again... Sorry.
...
:   Put some nice Schema.org-Meta-Data into the video-template for better SEO. If you want to know how to use the data, have a look into the front matter of the [video]({{ site.url }}/propostas/video/).
...
:   Now with author-support and [Schema.org microdata](http://schema.org). Edit author(s) in `authors.yml` and use it via front matter like `author: your_author_name`. Added [Disqus-comments]({{ site.url }}/propostas/comments/#comments) to the mix.
...
:   A new polished version, with a stronger and better color scheme. [Have a look ›]({{ site.url }}/propostas/grid/#color-scheme-and-colors-codes). Added foundation `.scss-files` to `assets/scss/` for savety.
...
<div id="videoModal" class="reveal-modal large" data-reveal="">
 ...
 [4]: {{ site.url }}/propostas/gallery/
 [5]: {{ site.url }}/propostas/video/
